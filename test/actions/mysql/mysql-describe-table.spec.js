...
const actions = require('../../../src/actions/mysql/mysql-describe-table');
const utils = require('../../../src/lib/utils');

describe('#actions/mysql-describe-table', () => {
  ...
  it('should execute a mysql command given', (done) => {
    ...
    actions.handler({
      ...
      assert.ok((stubCalledParams.toString()).includes(table));
      done();
    });
  });
  ...
  it('should handle errors properly and show query + exception', (done) => {
    ...
    actions.handler({
      ...
      assert.ok((e.toString()).includes(table));
